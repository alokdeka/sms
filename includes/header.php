...
<head>
    ...
    <meta name="keywords"
          content="stock management system, NIC, LCB College, BSc Final Year Project, Gauhati University">
    <!-- assets -->
    ...
    <!--date picker-->
    <!--link rel="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datetimepicker/3.1.1/css/bootstrap-datetimepicker.css"-->
